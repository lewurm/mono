...
IOS_DEFINES = ["HOST_DARWIN", "TARGET_MACH", "USE_MONO_CTX", "_XOPEN_SOURCE"]
ANDROID_DEFINES = ["HOST_ANDROID", "USE_MONO_CTX", "BIONIC_IOCTL_NO_SIGNEDNESS_OVERLOAD"]
LINUX_DEFINES = ["HOST_LINUX", "USE_MONO_CTX"]
...
class OffsetsTool:
	...
	def parse_args(self):
		...
		# Linux
			...
			self.target = Target ("TARGET_ARM", "TARGET_LINUX", ["ARM_FPU_VFP", "HAVE_ARMV5", "HAVE_ARMV6", "HAVE_ARMV7"] + LINUX_DEFINES)
	...
	def gen (self):
		...
		f.write ("#if defined (USE_CROSS_COMPILE_OFFSETS)\n")
